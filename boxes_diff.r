...
for(i in 1:length(wm$wm)) {                              # ggplot within for-loop
  p_box_justmonths(df_diff %>% filter(wmt == mons[i])) +
    ggtitle(paste0(mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_diffboxes.jpg"), dpi = 300, width = 22, height = 13, units = "in") 
}
...
for(i in 1:length(mons)) {                              # ggplot within for-loop
  p_box_monwyt(df_diff %>% filter(wmt_sjwytf == mons[i])) +
    ggtitle(paste0(mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_difftukeyboxplots.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
}
...
#  ggsave(paste0(lengmons[i], " - ", mons[i],
#                "_difftukeyboxplots_diff.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
#}
...
for(i in 1:length(mons)) {                              # ggplot within for-loop
  p_box_everymon(df_diff %>% filter(mon_yr_wy == mons[i])) +
    ggtitle(paste0(mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_difftukeyboxplots.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
}
...
for(i in 1:length(wm$wm)) {                              # ggplot within for-loop
  p_box_justvars(df_diff %>% filter(dv == mons[i])) +
    ggtitle(paste0(mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_diffboxes.jpg"), dpi = 300, width = 22, height = 13, units = "in") 
}
...
for(i in 1:length(mons)) {                              # ggplot within for-loop
  p_box_varswyt(df_diff %>% filter(dv_sjwytf == mons[i])) +
    ggtitle(paste0(mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_diffboxes.jpg"), dpi = 300, width = 22, height = 13, units = "in") 
}
...
for(i in 1:length(mons)) {                              # ggplot within for-loop
  p_box_varseverymonwyt(df_diff %>% filter(dv_wy_sjwytf == mons[i])) +
    ggtitle(paste0( mons[i]))
  ggsave(paste0(lengmons[i], " - ", mons[i],
                "_diffboxes.jpg"), dpi = 300, width = 22, height = 13, units = "in") 
}
