...
endDate <- "2023-06-12"
dischargeUnit_WY17_12Jun2023 <- readNWISuv(siteNumber, parameterCd, startDate, endDate, tz = "America/Los_Angeles")


## paste together 
dischargeUnit_WY88_5June2023 <- rbind( dischargeUnit_WY88_WY96,  dischargeUnit_WY97_WY06,
                                       dischargeUnit_WY07_WY16, dischargeUnit_WY17_12Jun2023)

# delete chunks to keep tidy
rm(dischargeUnit_WY88_WY96,  dischargeUnit_WY97_WY06, dischargeUnit_WY07_WY16, dischargeUnit_WY17_12Jun2023)
...
df <-   dischargeUnit_WY88_5June2023 %>% transmute(usgsid = siteNumber, dtmn = dateTime, cfs = Flow_Inst, Flow_Inst_cd, tz_cd) %>% mutate(
...
z <- ggplotly(pribbon)
htmlwidgets::saveWidget(as_widget(z), "sctt_ftjones_apr1.html")
